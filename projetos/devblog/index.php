					...
					<header>
						<fieldset id="nova_nota">
							...
							<form action="index.php" method="post">
								...
								<br><br>
								<input type="submit" name="task_devblog" value="Adicionar">
							</form>
						</fieldset>
					</header>
					<div id="notas">
						<table>
							...
							<tbody>
								<?php while($row = mysqli_fetch_array($tasks_devblog)){ ?>
									<tr>
					...
					<header>
						<fieldset id="nova_nota">
							...
							<form action="index.php" method="post">
								...
								<br>
								<input type="submit" name="adicionar_devblog" value="Adicionar">
							</form>
						</fieldset>
					</header>
					<div id="notas">
						<?php while ($row = mysqli_fetch_array($notas_devblog)) { ?>
							<article>
								<legend>
