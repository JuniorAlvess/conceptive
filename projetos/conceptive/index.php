					...
					<header>
						<fieldset id="nova_nota">
							...
							<form action="index.php" method="post">
								...
								<br><br>
								<input type="submit" name="task_conceptive" value="Adicionar">
							</form>
						</fieldset>
					</header>
					<div id="notas">
						<table>
							...
							<tbody>
								<?php while($row = mysqli_fetch_array($tasks_conceptive)){ ?>
									<tr>
					...
					<header>
						<fieldset id="nova_nota">
							...
							<form action="index.php" method="post">
								...
								<br>
								<input type="submit" name="adicionar_conceptive" value="Adicionar">
							</form>
						</fieldset>
					</header>
					<div id="notas">
						<?php while ($row = mysqli_fetch_array($notas_conceptive)) { ?>
							<article>
								<legend>
